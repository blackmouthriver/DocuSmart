...
class PptToPdfUseCaseTest {
    ...
    fun setUp() {
        ...
        // "=== Diapositiva N ===" ahora viene de context.getString(Int,
        // vararg) en vez de un literal hardcodeado en español -- ese
        // overload necesita su propio stub, mockk no relaxed no responde
        // nada por defecto.
