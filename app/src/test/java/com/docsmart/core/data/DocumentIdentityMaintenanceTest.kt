...
class DocumentIdentityMaintenanceTest {
    ...
    @Test
    fun `onIdChanged migra favorito, anotaciones, marcadores, notas, agenda e historial`() =
        runTest {
    ...
    @Test
    fun `onPermanentlyDeleted limpia todas las tablas y desvincula notas y agenda`() =
        runTest {
