...
class FavoritesRepositoryTest {
    ...
    @Test
    fun `toggleFavorite marca como favorito y persiste el cambio en SharedPreferences`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `toggleFavorite alterna, un segundo llamado quita el favorito`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `removeFavorite quita el favorito sin importar el estado actual (idempotente)`() = runTest {
        val repository = newRepository()
        repository.toggleFavorite("doc-1")
    ...
    @Test
    fun `removeFavorite sobre un documentId que nunca fue favorito no rompe nada`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `saveAlias guarda el alias y persiste el cambio en SharedPreferences`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `removeAlias elimina el alias y persiste el cambio en SharedPreferences`() = runTest {
        val repository = newRepository()
        repository.saveAlias("doc-1", "Contrato firmado")
    ...
    @Test
    fun `migrateId mueve el favorito del id viejo al id nuevo sin dejarlo huerfano`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `migrateId mueve el alias del id viejo al id nuevo sin dejarlo huerfano`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `migrateId mueve favorito y alias juntos en una sola migracion`() = runTest {
        val repository = newRepository()
        repository.toggleFavorite("ruta-vieja.pdf")
        repository.saveAlias("ruta-vieja.pdf", "Mi documento")
    ...
    @Test
    fun `migrateId no hace nada si el documento no era favorito ni tenia alias`() = runTest {
        val repository = newRepository()
    ...
    @Test
    fun `migrateId con el mismo id no altera favoritos ni alias`() = runTest {
        val repository = newRepository()
