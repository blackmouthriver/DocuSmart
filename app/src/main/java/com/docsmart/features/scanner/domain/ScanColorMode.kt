...
private val COLOR_IDENTITY_MATRIX =
    floatArrayOf(
        1f,
        0f,
        0f,
...
private val BLACK_AND_WHITE_MATRIX =
    floatArrayOf(
        LUMA_R * BW_CONTRAST_FACTOR,
        LUMA_G * BW_CONTRAST_FACTOR,
        LUMA_B * BW_CONTRAST_FACTOR,
        0f,
        BW_TRANSLATE,
        LUMA_R * BW_CONTRAST_FACTOR,
        LUMA_G * BW_CONTRAST_FACTOR,
...
private val HIGHLIGHT_TEXT_MATRIX =
    floatArrayOf(
        HIGHLIGHT_CONTRAST_FACTOR,
        0f,
        0f,
        0f,
        HIGHLIGHT_BRIGHTNESS_OFFSET,
        0f,
        HIGHLIGHT_CONTRAST_FACTOR,
        0f,
        0f,
 ...
 */
fun buildColorModeMatrix(mode: ScanColorMode): FloatArray =
    when (mode) {
