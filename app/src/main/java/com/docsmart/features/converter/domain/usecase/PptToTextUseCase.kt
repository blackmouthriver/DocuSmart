...
class PptToTextUseCase
    ...
    constructor(
        ...
        private fun addSlideTextIfMatch(
            zip: ZipInputStream,
            entryName: String,
            slideMap: MutableMap<Int, String>,
        ) {
        ...
        private fun slideNumberFromEntryName(entryName: String) =
            entryName
