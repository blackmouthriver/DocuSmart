...
// Lanzamiento inicial 2026-09-10: chips Word/Excel/PowerPoint ocultos a
// pedido del usuario para el primer release, mismo criterio que las
// categorías del Convertidor (ver ConversionType.HIDDEN_FROM_UI). Un
// documento .doc/.xlsx/.pptx real sigue apareciendo en "Todos" -- solo se
// oculta el filtro específico. Reactivar es descomentar estas 3 líneas.
