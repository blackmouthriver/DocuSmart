...
data class ComparePdfMessages(
    ...
    // formato: %1$d páginas distintas, %2$d páginas totales
    val differencesFound: String,
    // formato: %1$s mensaje de excepción
    val genericError: String,
    val reportTitle: String,
    // formato: %1$d número de página
    val reportPageHeader: String,
    val reportPageOnlyInA: String,
    val reportPageOnlyInB: String,
    // formato: %1$s línea
    val reportOnlyInALine: String,
    // formato: %1$s línea
    val reportOnlyInBLine: String,
)
        ...
        private fun buildPageDiff(
            ...
            when {
                textA == null ->
                    PageDiffResult(
                        pageNumber,
                        pageExistsOnlyInA = false,
                        pageExistsOnlyInB = true,
                        emptyList(),
                        emptyList(),
                    )
                textB == null ->
                    PageDiffResult(
                        pageNumber,
                        pageExistsOnlyInA = true,
                        pageExistsOnlyInB = false,
                        emptyList(),
                        emptyList(),
                    )
                else -> {
