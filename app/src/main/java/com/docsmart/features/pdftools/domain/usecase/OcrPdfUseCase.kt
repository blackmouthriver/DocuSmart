...
data class OcrPdfMessages(
    ...
    // formato: %1$d páginas, %2$d palabras reconocidas
    val success: String,
 ...
 * pura, testeable.
 */
internal fun horizontalScalingPercent(
    naturalWidthPts: Float,
    targetWidthPts: Float,
): Float {
...
class OcrPdfUseCase
    ...
    constructor(
        ...
        private fun drawInvisibleTextLayer(
            ...
            val words =
                text.textBlocks.flatMap { it.lines }.flatMap { it.elements }
                    .mapNotNull { element ->
