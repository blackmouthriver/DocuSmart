...
data class ExtractImagesMessages(
    ...
    val noPages      : String,
    val noImages     : String, // AC2: PDF sin imágenes embebidas
    val success       : String, // formato: %1$d imágenes extraídas
...
class ExtractImagesFromPdfUseCase @Inject constructor(
    ...
    private fun extractAllImages(
        pdfDoc: PdfDocument, baseName: String, timestamp: String, savedFiles: MutableList<File>
    ) {
    ...
    @Suppress("TooGenericExceptionCaught")
    private fun readImageBytes(image: PdfImageXObject, pageNumber: Int): ByteArray? = try {
    ...
    private fun createOutputFile(baseName: String, index: Int, extension: String, timestamp: String): File {
