...
data class EditTextPdfMessages(
    ...
    // formato: %1$d ocurrencias reemplazadas
    val success: String,
        ...
        suspend operator fun invoke(
            ...
            withContext(Dispatchers.IO) {
                ...
                try {
                    ...
                    outputFile = createOutputFile(outputFileName ?: "Editado")
                    ...
                    Timber.e("$TAG: error al editar texto del PDF: ${e.javaClass.simpleName}")
                    outputFile?.delete()
