...
// Hallazgo real de la auditoría general 2026-09-17 (B21):
// AgendaLinkDocumentDialog y NoteLinkDocumentDialog eran una duplicación
// casi textual (HU-65 copiada de la #50 original) -- la única diferencia
// real entre ambas eran 3 strings (título, mensaje vacío, etiqueta de
// desvincular). Se deja un único componente parametrizado por esos 3
// textos; cada pantalla conserva su propia función pública con el mismo
// nombre/firma de antes (los call sites no cambian) que solo resuelve sus
// stringResource y delega acá.
@Composable
