...
/**
 * Estado vacío: una invitación, no una disculpa. Icono en círculo tonal,
 * título que nombra el espacio, mensaje de una línea y (opcional) una
 * acción principal. Reemplaza los "vacíos" hechos a mano de cada pantalla.
 */
@Composable
