...
- **Backlog de mejoras/UX catalogado 2026-08-30** (sin ejecutar todavía, a la espera de priorización del usuario): 12 pedidos nuevos (atajos de Convertir/QR desde un archivo, captura por cámara, grilla de accesos rápidos, banner azul uniforme con "Volver", banner de anuncios consistente, ampliar Personalización en Ajustes, botón Papelera inconsistente, actualización de splash screens/íconos con diseño nuevo pendiente de que el usuario entregue los assets, etc.) más una revisión UX heurística propia con hallazgos adicionales y preguntas abiertas de producto. Ver [`docs/requirements/backlog-mejoras-ux-2026-08-30.md`](docs/requirements/backlog-mejoras-ux-2026-08-30.md).
